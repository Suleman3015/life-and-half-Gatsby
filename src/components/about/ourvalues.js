    ...
    return (
        <section className="text-gray-600 body-font">
            <div style={{ display: "flex", flexDirection: 'column', marginLeft: "4%" }}>
                <h1 style={{ fontSize: "20px", color: "#3b66ea", marginBottom: "3%" }} >OUR VALUES & BELIEFS </h1>
                <h2 style={{ fontSize: "28px", color: "black" }}>With empathy, qualification and perseverance we are here to take over your Amazon FBA business.</h2>
            </div>
